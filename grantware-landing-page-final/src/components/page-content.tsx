...
function PageContentInner() {
  ...
  return (
    <main className="min-h-screen relative bg-white">
      {/* Full-page ShaderGradient background (fixed) - COMMENTED OUT FOR NOW */}
      {/* To re-enable: uncomment imports above, uncomment ThemeProvider wrapper below, and uncomment this line: */}
      {/* {isGradient && <HeroShaderGradient />} */}
...
export function PageContent() {
  // To re-enable gradient toggle, wrap PageContentInner with ThemeProvider:
  // return (
  //   <ThemeProvider>
  //     <PageContentInner />
  //   </ThemeProvider>
  // )
  return <PageContentInner />
}
