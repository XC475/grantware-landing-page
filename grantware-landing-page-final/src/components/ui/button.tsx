  ...
  (
    ...
    return (
      <motion.button
        ...
        {...props}
      >
        {isLoading ? <IconLoader2 size={TABLER_ICON_SIZE} className="animate-spin" /> : <></>}
        {!isLoading && supportIcon && <SupportIconRender size={TABLER_ICON_SIZE} />}
        {children}
        {leadingIcon && <LeadingIconRender size={TABLER_ICON_SIZE} />}
      </motion.button>
    )
  }
)
